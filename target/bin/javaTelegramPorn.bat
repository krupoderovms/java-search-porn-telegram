...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="javaTelegramPorn" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.home.server.TelegramBot %CMD_LINE_ARGS%
